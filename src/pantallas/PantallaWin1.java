...
/**
 * Pantalla de ganar la partida
 * 
 * @author Juan Jose Prieto Talavero
 */

public class PantallaWin1 implements Pantalla {
    ...
    public PantallaWin1(PanelJuego panelJuego) {
    ...
    public void inicializarPantalla() {
        ...
        fondo = null;
        try {
            fondo = ImageIO.read(new File("Imagenes/w1.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void pintarPantalla(Graphics g) {
        ...
        g.drawString("J2 LOSE", panelJuego.getWidth() - 250, 150);
        g.drawString("J1 WIN", 50, panelJuego.getHeight() - 130);
    }
